...
const profileVerifiedIcon = () => {
  return (
    ...
    >
      ...
      />
      <path
        d="M8.64282 11.2679L10.6071 13.2322L14.3571 8.85718"
        stroke="white"
        stroke-width="1.5"
...
const commentObject = [
  {
    ...
    title:
      "Yevhen produced a wireframe, ui and design style guide for a custom e-commerce site. He did the work on time and with a great design eye. Nice design touch",
  ...
  const GridArr = [
    {
      ...
      profileImage: (
        <img
          src={Images.profileGrid}
          className={
            dark
              ? "grid-profile-image grid-profile-image-dark"
              : "grid-profile-image"
          }
        />
      ),
    ...
    <>
      {view === "List" ? (
        <div
          className={
            dark
              ? "card-list-container card-list-container-dark"
              : "card-list-container"
          }
                ...
                <Grid item xs={12} sm={7} md={6} lg={4}>
                  <Grid container spacing={2}>
                    <Grid item sm={2.5}>
                      ...
                      <div className="profileVerifiedList-Icon">
                        {profileVerifiedIcon()}
                      </div>
                    </Grid>
                    <Grid item sm={9}>
                      <div
                        className={
                          dark
                            ? "List-profile-name List-profile-name-dark"
                            : "List-profile-name"
                        }
                      >
                        {item?.profileName}
                      </div>
                      <div className="List-profile-desc">
                        {item?.profileDesc}
                      </div>
                      <div
                        className={
                          dark
                            ? "timeList-Container timeList-dark"
                            : "timeList-Container"
                        }
                      >
                      ...
                      <div className="commentRating-container">
                        <div
                          className={
                            dark
                              ? "commentsRating-Listcount commentsRating-Listcount-dark"
                              : "commentsRating-Listcount"
                          }
                        >
                          <div className="margin-icon">{commentIcon()}</div>{" "}
                          {item?.commentCount}{" "}
                          <span className="commentsRating-Listtitle">
                            Comments
                          </span>
                        </div>
                        <div
                  ...
                  <div className="images-List-center">
                    {item?.specialization.map((e) => (
                      <div
                        className={
                          dark
                            ? "container-List-desc container-List-desc-dark"
                            : "container-List-desc"
                        }
                        key={e}
                      >
        ...
        <div
          ...
          className={
            dark
              ? "card-grid-container card-grid-container-dark"
              : "card-grid-container"
          }
        >
          {GridArr.map((item) => (
            <>
              <div
                className={
                  dark ? "time-Container time-Container-dark" : "time-Container"
                }
              >
                $75{" "}
                <span
                  className={
                    dark
                      ? "time-hours-title time-hours-title-dark "
                      : "time-hours-title"
                  }
                >
                  /hour
              ...
              <div
                className="images-grid-center"
                style={{ position: "relative" }}
              >
                {item?.profileImage}{" "}
                <div className="profileVerified-Icon">
                  {profileVerifiedIcon()}
                </div>
              </div>
              ...
              <div className="grid-profile-desc">
              ...
              <div className="images-grid-center">
                {item?.specialization.map((e) => (
                  <div
                    className={
                      dark
                        ? "container-grid-desc container-grid-desc-dark"
                        : "container-grid-desc"
                    }
                    key={e}
                  >
              ...
              <div className="commentRating-container">
                <div
                  className={
                    dark
                      ? "commentsRating-count commentsRating-count-dark"
                      : "commentsRating-count"
                  }
                >
                  <div className="margin-icon">{commentIcon(dark)}</div>{" "}
                  {item?.commentCount}{" "}
                  <span className="commentsRating-title">Comments</span>
                </div>
                <div
                  className={
                    dark
                ...
                >
                  {item?.ratingCount}{" "}
                  <span className="commentsRating-title">Rating</span>
                </div>
              </div>
            </>
          ))}
          ...
          PaperProps={
            !dark
              ? {
                  sx: {
                    borderRadius: "15px",
                    width: { xs: "100%", sm: "50%", md: "35%", lg: "24%" },
                    right: 0,
                    height: "100%",
                    overflow: "hidden",
                  },
        ...
        >
          <DialogTitle>
            <div className="modalHeader-container">
              <div
                className={
                  dark ? "modalheading modalheading-dark" : "modalheading"
                }
              >
                {" "}
                Reviews
          ...
          >
            <DialogContentText>
              ...
              <div
                className={
                  dark
                    ? "dialog-profile-name dialog-profile-name-dark "
                    : "dialog-profile-name"
                }
              >
                Ryan Jackson
              ...
              <div
                className={
                  dark
                    ? "rating-Container rating-Container-dark "
                    : "rating-Container"
                }
              >
              ...
              <div
                className={
                  dark
                    ? "Comments-dialogTitle Comments-dialogTitle-dark"
              ...
              >
                ...
                <span
                  className={
                    dark
                      ? "container-commentsCount Comments-dialogTitle-dark"
              ...
              {commentObject.map((item) => (
                <div className="dialogComment-box">
                  <div className="modalHeader-container">
                    <div style={{ display: "flex" }}>
                      ...
                      <div
                        className={
                          dark
                            ? "rating-ContainerDialog dialogTitle-dark"
                            : "rating-ContainerDialog "
                        }
                      >
                        4.5<span className="timehoursList-title">/5</span>
                      </div>
                  ...
                  <div
                    className={
                      dark
                        ? "commentName-title  dialogTitle-dark"
                        : "commentName-title"
                    }
                  >
                    {item?.Heading}
                  ...
                  >
                    ...
                    <span
                      className={
                        dark
                          ? "comment-DialogDate  dialogTitle-dark"
                          : "comment-DialogDate"
                      }
                    >
                      {item?.date}
